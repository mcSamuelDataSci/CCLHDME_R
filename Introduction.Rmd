...
The workshop learning approach is live demonstration, with participants then doing the same steps live, as possible. Or just watching, and looking at the materials later. There are many different approaches, resources, styles, and preferences for learning R (or anything?).
