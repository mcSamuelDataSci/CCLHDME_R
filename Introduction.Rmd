...
1. download R_CCLHDME.zip from email and unzip in folder of you choosing, OR
2. go [GitHub], download ZIPPPPPPPPP, and unzip...
3. go to (Michael's doogle drive) and download all files to folder of your choosing
...
@ JASPREET
@@ go to folder where workshop files located and open "CCLHDME_R.Rproj" OR
@@ in Studio navigate to the folder....
